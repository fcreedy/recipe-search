...
const About = () => {
    ...
    return(
        <div className='about-page block'>
            ...
            <div className="about-summary text-sm leading-relaxed w-3/5">
            ...
            <a className="link-button bg-apple-yellow text-sm text-center font-semibold rounded-md border-0 m-4 w-56 p-3 hover:drop-shadow-md cursor-pointer duration-500 block" href="https://fionacreedy.myportfolio.com/" title="View Fiona's full portfolio">
                View Fiona&lsquo;s full portfolio
            </a>
           
            <a className="link-button bg-apple-yellow text-sm text-center font-semibold rounded-md border-0 m-4 w-56 p-3 hover:drop-shadow-md cursor-pointer duration-500 block" href="https://www.linkedin.com/in/fionacreedy/" title="View Fiona's LinkedIn profile">
