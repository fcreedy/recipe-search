...
const About = () => {
    ...
    return(
        <div className='about-page block'>
            ...
            <button type="button" href="https://fionacreedy.myportfolio.com/" title="View Fiona's full portfolio" className="bg-apple-yellow text-sm text-center font-semibold rounded-md border-0 m-4 w-56 p-3 hover:drop-shadow-md cursor-pointer duration-500 block">
                View Fiona&lsquo;s full portfolio
            </button>
           
            <button type="button" href="https://www.linkedin.com/in/fionacreedy/" title="View Fiona's LinkedIn profile" className="bg-apple-yellow text-sm text-center font-semibold rounded-md border-0 m-4 w-56 p-3 hover:drop-shadow-md cursor-pointer duration-500 block">
